...
const PrivacyPolicyPage = () => {
  return (
    <>
      <SEO
        title="Integritetspolicy - Lupinkampen"
        description="Vi på Lupinkampen är måna om att skydda din integritet och personliga information."
        url="https://lupinkampen.vercel.app/#/integritetspolicy"
      />
        ...
        <div className="user-terms-container">
          <div className="user-terms-info">
            ...
            <p>
              ...
              samlar in, använder, lagrar och skyddar dina personuppgifter när
              du använder vår tjänst Lupinkampen. Genom att använda vår tjänst
          ...
          <div className="terms-container">
            <div className="terms-paragraph">
              ...
              <ul className="terms-ul">
                <li>
                  ...
                  vår tjänst samlar vi in information som ditt namn,
                  e-postadress och användarnamn.
                </li>
                <li>
            ...
            <div className="terms-paragraph">
              ...
              <ul className="terms-ul">
                <li>
                  ...
                  För att säkerställa att du kan använda vår tjänst och
            ...
            <div className="terms-paragraph">
              ...
              <p>
                Vi säljer inte din personliga information till tredje part. Vi
                kan dock dela din information med tredje parter under följande
                omständigheter:
              </p>
              <ul className="terms-ul">
                <li>
                  ...
                  information för att utföra tjänster åt oss och får inte dela
                  den med andra.
                </li>
                <li>
                  <span>Lagkrav: </span>
            ...
            <div className="terms-paragraph">
              ...
              <ul className="terms-ul">
                <li>
                  <span>Begära åtkomst till din information: </span>Du kan
                ...
                <li>
                  ...
                  personliga information, med vissa undantag (t.ex. lagliga
                  krav).
                </li>
                <li>
            ...
            <div className="terms-paragraph">
              ...
              <p>
                ...
                radering. Trots dessa åtgärder kan vi inte garantera 100%
                säkerhet för dataöverföringar på internet, men vi strävar efter
                att upprätthålla högsta möjliga säkerhet.
              </p>
            </div>
